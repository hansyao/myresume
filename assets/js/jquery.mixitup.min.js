...
(function (e) {
    function n(d, b, h, c, a) {
        function k() {
            ...
            "list" == a.layoutMode ?
                (r.css({
                    ...
                    opacity: "1"
                }), a.origDisplay = a.targetDisplayList) : (r.css({
        ...
        for (var g = a.transitionSpeed, f = 0; 2 >
            f; f++) {
            var p = 0 == f ? p = a.prefix : "";
            a.transition[p + "transition"] = "all " + g + "ms linear";
            a.transition[p + "transform"] = p + "translate3d(0,0,0)";
            a.perspective[p + "perspective"] = a.perspectiveDistance + "px";
            a.perspective[p + "perspective-origin"] = a.perspectiveOrigin
        }
        ...
        if ("or" == a.filterLogic) {
            var n = d.split(".");
            !0 == a.multiFilter && "" == n[0] && n.shift();
            1 > n.length ? t = t.add(c.find(s + ":visible")) : v.each(function () {
                for (var a = 0, b = e(this), c = 0; c < n.length; c++) b.hasClass(n[c]) && (r = r.add(b), a++);
                0 == a && (t = t.add(b))
            })
        } else r = r.add(l.find(s + "." +
            d)), t = t.add(l.find(s + ":not(." + d + "):visible"));
        d = r.length;
        var u = e(),
            q = e(),
            m = e();
        ...
        if (r.filter(":visible").length == d && !u.length && !b) {
            if (a.origLayout == a.layoutMode) return k(), !1;
            if (1 == r.length) return "list" == a.layoutMode ? (c.addClass(a.listClass), c.removeClass(a.gridClass), m.css("display", a.targetDisplayList)) : (c.addClass(a.gridClass), c.removeClass(a.listClass), m.css("display", a.targetDisplayGrid)), k(), !1
        }
        ...
        if (r.length) {
            ...
            if (a.origLayout != a.layoutMode && !1 == a.animateGridList) return "list" == a.layoutMode ? (c.addClass(a.listClass), c.removeClass(a.gridClass), m.css("display", a.targetDisplayList)) : (c.addClass(a.gridClass), c.removeClass(a.listClass), m.css("display", a.targetDisplayGrid)), k(), !1;
            ...
            "list" == a.layoutMode ?
                (c.addClass(a.listClass), c.removeClass(a.gridClass), q.css("display", a.targetDisplayList)) : (c.addClass(a.gridClass), c.removeClass(a.listClass), q.css("display", a.targetDisplayGrid));
            q.each(function () {
            ...
            b && w(b, h, c, a);
            if (b && a.origSort.compare(a.checkSort)) return k(),
                !1;
            u.hide();
            q.each(function () {
            ...
            "block" == a.origDisplay ? (c.addClass(a.listClass), q.css("display", a.targetDisplayList)) : (c.removeClass(a.listClass), q.css("display", a.targetDisplayGrid));
            a.resizeContainer && l.css("height", a.origHeight + "px");
            d = {};
            for (f = 0; 2 > f; f++) p = 0 == f ? p = a.prefix : "", d[p + "transform"] = a.scale + " " + a.rotateX + " " +
                a.rotateY + " " + a.rotateZ, d[p + "filter"] = a.blur + " " + a.grayscale;
            q.css(d);
            m.each(function () {
                var b = this.data,
                    c = e(this);
            ...
            setTimeout(function () {
                ...
                l.bind("webkitTransitionEnd transitionend otransitionend oTransitionEnd", function (a) {
                    if (-1 <
                        a.originalEvent.propertyName.indexOf("transform") || -1 < a.originalEvent.propertyName.indexOf("opacity")) - 1 < s.indexOf(".") ? e(a.target).hasClass(s.replace(".", "")) && k() : e(a.target).is(s) && k()
                })
            }, 10);
            ...
            setTimeout(function () {
                ...
                if (t.length) {
                    ...
                    l.bind("webkitTransitionEnd transitionend otransitionend oTransitionEnd", function (b) {
                        if (-1 < b.originalEvent.propertyName.indexOf("transform") || -1 < b.originalEvent.propertyName.indexOf("opacity")) c.addClass(a.failClass), k()
                    })
                } else a.mixing = !1
            }, 10)
        }
    ...
    function w(d, b,
        ...
        if ("reset" == d) e.each(c.startOrder,
            ...
            if (!c.newOrder.length) {
                for (var g = c.startOrder.slice(), p = g.length, s = p; s--;) {
    ...
    var x = {
        ...
        toGrid: function () {
            return this.each(function () {
                var d = this.config;
                "grid" != d.layoutMode && (d.layoutMode = "grid", n(d.filter, null, null, e(this), d))
            })
        },
        toList: function () {
            return this.each(function () {
                var d = this.config;
                "list" != d.layoutMode && (d.layoutMode = "list", n(d.filter, null, null,
                    e(this), d))
            })
        },
        filter: function (d) {
            return this.each(function () {
                ...
                "all" == d && (d = "mix_all");
                b.mixing || (b.filter = d, n(d, null, null, e(this), b))
            })
        },
        sort: function (d) {
            return this.each(function () {
                ...
                b.mixing || (e(this).find(b.targetSelector).each(function () {
                    b.startOrder.push(e(this))
                }), n(b.filter, h, c, e(this), b))
            })
        }
    };
    e.fn.mixitup =
        function (d, b) {
            if (x[d]) return x[d].apply(this, Array.prototype.slice.call(arguments, 1));
            if ("object" === typeof d || !d) return x.init.apply(this, arguments)
        };
